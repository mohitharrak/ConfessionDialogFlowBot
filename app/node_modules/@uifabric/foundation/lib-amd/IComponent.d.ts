 ...
 */
export declare type IViewComponent<TViewProps> = (props: IPropsWithChildren<TViewProps>) => JSX.Element | null;
/**
 * Handles rendering view component.
 */
export declare type IViewRenderer<TViewProps> = (props?: TViewProps) => JSX.Element | null;
/**
