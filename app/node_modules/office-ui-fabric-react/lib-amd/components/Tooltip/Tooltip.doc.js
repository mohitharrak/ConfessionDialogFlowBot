define(["require", "exports", "react", "./examples/Tooltip.Custom.Example", "./examples/Tooltip.Basic.Example", "./examples/Tooltip.Display.Example", "./examples/Tooltip.Interactive.Example", "./examples/Tooltip.Overflow.Example", "./examples/Tooltip.NoScroll.Example", "./examples/Tooltip.Absolute.Position.Example", "./Tooltip.checklist"], function (require, exports, React, Tooltip_Custom_Example_1, Tooltip_Basic_Example_1, Tooltip_Display_Example_1, Tooltip_Interactive_Example_1, Tooltip_Overflow_Example_1, Tooltip_NoScroll_Example_1, Tooltip_Absolute_Position_Example_1, Tooltip_checklist_1) {
    "use strict";
