define(["require", "exports", "react", "./examples/Text.Ramp.Example", "./examples/Text.Wrap.Example", "./examples/Text.Block.Example", "./examples/Text.Inherits.Example"], function (require, exports, React, Text_Ramp_Example_1, Text_Wrap_Example_1, Text_Block_Example_1, Text_Inherits_Example_1) {
    "use strict";
    ...
    var TextRampExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Text/Text.Ramp.Example.Codepen.txt');
    var TextWrapExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Text/examples/Text.Wrap.Example.tsx');
    var TextWrapExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Text/Text.Wrap.Example.Codepen.txt');
    var TextBlockExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Text/examples/Text.Block.Example.tsx');
    var TextBlockExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Text/Text.Block.Example.Codepen.txt');
    var TextInheritsExampleCode = require('!raw-loader!office-ui-fabric-react/src/components/Text/examples/Text.Inherits.Example.tsx');
    var TextInheritsExampleCodepen = require('!raw-loader!office-ui-fabric-react/lib/codepen/components/Text/Text.Inherits.Example.Codepen.txt');
    exports.TextPageProps = {
        ...
        examples: [
            ...
            },
            {
                ...
                view: React.createElement(Text_Inherits_Example_1.TextInheritsExample, null),
                codepenJS: TextInheritsExampleCodepen
            }
        ],
        propertiesTablesSources: [require('!raw-loader!office-ui-fabric-react/src/components/Text/Text.types.tsx')],
